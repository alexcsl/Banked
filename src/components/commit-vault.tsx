...
import { allocateCommitDeposit, validateCommitPolicy, type CommitPolicyV1 } from "@/domain/commit/policy";
  ...
  return <div className="workspace commit-workspace">
    ...
    <main>
      ...
      <section className="workspace-grid">
        <section className="rule-workbench" aria-labelledby="commit-policy"><div className="section-heading"><div><p className="section-kicker">01 · DEFINE</p><h2 id="commit-policy">Spending mandate</h2></div><button className="link-button" onClick={saveDraft}>Save draft</button></div><div className="form-stack">
